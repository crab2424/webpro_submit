...
\begin{itemize}
    \item URL: /stella/:id
    \item 処理: URLパラメータのidに基づき配列を検索し，対象データを表示する．なお，指定したidに対応するデータが存在しない場合は，一覧表示ページ(/stella)へリダイレクトする．
...
\begin{itemize}
    \item フォーム: GET /stella/edit/:id
        \begin{itemize}
            \item 処理: 対象データを検索し，value属性に現在の値を埋め込んで表示する．なお，指定したidに対応するデータが存在しない場合は，一覧表示ページ(/stella)へリダイレクトする．
...
\begin{itemize}
    \item フォーム: GET /stella/check/:id
        \begin{itemize}
            \item 簡易確認フォームを表示する．なお，指定したidに対応するデータが存在しない場合は，一覧表示ページ(/stella)へリダイレクトする．
