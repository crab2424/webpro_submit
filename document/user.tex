...
\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{fig/user/edit.png}
    \caption{編集画面}
    \label{fig:user_edit}
\end{figure}

\subsection{データ削除}
図\ref{fig:user_check}の詳細画面の「削除」ボタンを押すと、確認画面が表示される。
削除対象のデータを確認し、問題なければ実行することでデータが削除される。

\begin{figure}[H]
    \centering
    \includegraphics[width=8cm]{fig/user/check.png}
    \caption{削除確認画面}
    \label{fig:user_check}
\end{figure}
